...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> c
...
<button type="button" name="submit2"  id="exit" onclick="disableButtons(this)" class="btn btn-default" style="width:94px;">
Exit
</button>
</div>
</form>
...
if(isset($_POST['save']))
{
	...
	$insert="insert into ftd_smpl_milk(Tran_Date,Fran_Name,Bmc_Code,Bmc_Name,Qty,Fat,Snf,Amount,Add_Date,Add_user,D_Flag)values('".$_POST['date']."','".$_POST['Franchise']."','".$bmc[0]."','".$bmc[1]."',".$_POST['quantity'].",".$_POST['fat'].",".$_POST['snf'].",".$_POST['amount'].",'".date("Y-m-d")."','".$_SESSION['login_user']."','-');";
