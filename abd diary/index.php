...
<div class="row">
  <div id="myCarousel" class="carousel slide space"  data-ride="carousel" >
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="sakthi_brands.jpg" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
	  ...
	  <div class="item">
        <img src="milk.JPG" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
	  <div class="item">
        <img src="Premium_Curd.JPG" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
	  <div class="item">
        <img src="paneer.JPG" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
	  <div class="item">
        <img src="ghee.JPG" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
	  <div class="item">
        <img src="butter.JPG" class="img-responsive center-block" alt="Image" style="margin-top:5.5%;">
      </div>
    </div>
 ...
 <div class="col-sm-9" style="margin-left:12.78%;height:400px;">
  <img class="avt" src="sakthifoods.png">
  <img class="avt" src="sakthifoods2.PNG">
  <img class="avt" src="sakthifinance.png">
  <img class="avt" src="kct-logo.jpg">
 </div>
   </div>
