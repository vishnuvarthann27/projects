...
$("#modify_u").click(function(){
	...
	$.ajax({
		...
		success:function(data){
			alert(data);
			location.replace("localsales.php");
		}
	});
});
...
<form name="localsales" action="localsales.php" method="post" >
<table>
...
<td><input class="form-control" id="quantity" type="text" name="quantity" placeholder="enter the quantity" align="center" style="width:380px;font-size:10pt" ng-model="quantity" ng-disabled="!bmc"></td>
</tr>
<tr height="35px">
...
<button type="button" name="submit2" id="view" onclick="disableButtons(this)"  class="btn btn-default" style="width:95px;" ng-model="view"  accesskey="v">
View
</button>
